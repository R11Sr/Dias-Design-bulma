...
<!-- This page is  is used to update a product -->
...
<?php
  ...
  include("$root" . "/Dias-Design-bulma/root_credentials.php"); //requires the root_credentials to run
?>

<?php
  // fetchs the product info
  ...
  foreach($product_info as $row){  //array of array with a sngle element
    foreach($row as $innerrow){
      array_push($array_info,$innerrow); //pushes row on array_info
    }
  }
    ...
    <div class="container">
      <div class="columns">
        <div class="column is-half">
          ...
          <form action="Menu Manager/menu_manger_update_service.php" method="POST">
            ...
            <!-- pre-selects the option with what exists using the 'echo' to print 'selected' -->
