-- This file is to create the db, insert the products and authorises the user 'dias_design'
-- to use the db
...
--
-- Table structure for table `Images` CURRENTLY THIS TABLE IS NOT USED
--
