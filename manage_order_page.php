...
<head>
    ...
    <script src="JS/Manage Order Page.js"></script>
...
<body>
    ...
    <?php
        ...
        include("$root" . "/Dias-Design-bulma/root_credentials.php");
            ...
            // return if a file name is present or not
            if($status)
            {
    ...
    <table id="table">
        ...
        <?php foreach($order_list as $order):?> <!-- displays the order list -->
            ...
            <tr>
                ...
                <!--This button allows you to download a pdf version of the invoice if one has been uploaded -->
